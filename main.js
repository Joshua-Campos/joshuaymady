// Proteger página
if (!localStorage.getItem("madiqueem-auth")) {
...
function updateCountdown() {
  ...
  if (diff < 0) {
    document.getElementById('countdown').innerHTML = "¡HOY ES TU CUMPLE, MI AMOR!";
    confettiRain();
    return;
  }
...
const responses = [
  "Yo te amo más que al helado con extra chispitas ♡",
